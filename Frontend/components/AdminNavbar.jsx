...
const adminLinks = [
  ...
  { name: 'Manage Hotels', href: '/admin/hotels', icon: HomeModernIcon },
  { name: 'Bookings Overview', href: '/admin/bookings', icon: CalendarDaysIcon },
    ...
    <header className="bg-white shadow-sm">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 text-gray-900">
          <a href="/admin/dashboard" className="text-sm font-semibold text-gray-900">Dashboard</a>
          <a href="/admin/users" className="text-sm font-semibold text-gray-900">Users</a>
          <a href="/admin/hotels" className="text-sm font-semibold text-gray-900">Hotels</a>
        </PopoverGroup>
